    ...
    <nav class="navbar bg-light">
      <div class="container">
        ...
        <form class="d-flex" role="search" method="get" action="details">
          <input class="form-control me-1" type="text" placeholder="Masukan Asal Perusahaan" name="cari" style="height: 35px; width: 400px" required />
  ...
  <main>
    <div class="container">
      ...
      <div class="table-responsive">
        ...
        if ($foundnum == 0) {
          echo "Kami tidak dapat menemukan asal perusahaan '<b>$search</b>'.";
        } else {
