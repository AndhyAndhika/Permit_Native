                            ...
                            <table id="datatablesSimple" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    if (isset($_GET['filter'])) {
                                        ...
                                        $query = "SELECT * FROM absensi WHERE approval=5 AND last_approval BETWEEN '$start' AND '$end' ORDER BY last_approval ASC;";
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "https://smartsyst.my.id/permit/admin/loginadmin/download/absensi/download.php?start=" + start + "&end=" + end;
                                    });
