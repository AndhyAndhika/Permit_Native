        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="mt-5 mt-lg-5 px-0 pt-3">
                ...
                <div class="container-fluid">
                    <h3>C U T I </h3>
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-primary mb-1">
                            ...
                            <table id="datatablesSimple" border="1" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    if (isset($_GET['filter'])) {
                                        ...
                                        $query = "SELECT * FROM cuti WHERE approval=5 AND last_approval BETWEEN '$start' AND '$end' ORDER BY last_approval ASC;";
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../../../dashboard/administrasi/lampiran/<?= $tampil['lampiran']; ?>" style="max-width:100px; max-height:100px"></td>
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "https://smartsyst.my.id/permit/admin/loginadmin/download/cuti/download.php?start=" + start + "&end=" + end;
                                    });
