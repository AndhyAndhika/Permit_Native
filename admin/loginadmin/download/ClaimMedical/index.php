...
<head>
    ...
    <title>Claim Medical | Download</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-white" style="background-color: #de9ecc;">
                            ...
                            <span>B e r i k u t &ensp; A d a l a h &ensp; R i w a y a t &ensp; C L A I M &ensp; M E D I C A L </span>
                        </div>
                            ...
                            <table id="datatablesSimple" border="1" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "https://smartsyst.my.id/permit/admin/loginadmin/download/ClaimMedical/download.php?start=" + start + "&end=" + end;
                                    });
