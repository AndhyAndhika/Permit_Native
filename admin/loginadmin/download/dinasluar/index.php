...
<head>
    ...
    <title>Dinas Luar | Download</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-white" style="background-color: #aeaaaa;">
                            ...
                            <span>Berikut adalah daftar Karyawan Yang Dinas Luar Bulan ini</span>
                        </div>
                            ...
                            <table id="datatablesSimple" border="1" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    if (isset($_GET['filter'])) {
                                        ...
                                        $query = "SELECT * FROM dinasluar WHERE approval=5 AND last_approval BETWEEN '$start' AND '$end' ORDER BY last_approval ASC;";
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "https://smartsyst.my.id/permit/admin/loginadmin/download/dinasluar/download.php?start=" + start + "&end=" + end;
                                    });
