        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="mt-5 mt-lg-5 px-0 pt-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-dark" style="background-color: #a9d08e;">
                            ...
                            <table id="datatablesSimple" border="1" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <script>
                                    ...
                                    button.addEventListener('click', function() {
                                        ...
                                        window.location.href = "https://smartsyst.my.id/permit/admin/loginadmin/download/dispensasi/download.php?start=" + start + "&end=" + end;
                                    });
