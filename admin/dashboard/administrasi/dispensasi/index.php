        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" class="mt-5 mt-lg-5 px-0 pt-3">
                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="POST">
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel ">Dispensasi</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row ">
                                            ...
                                            <div class="col col-12  col-lg-6 pr-3">
                                                <div class="row">
                                                    <div class="col col-3  pt-2  mt-3 ">Keperluan</div>
                                                ...
                                                <div class="row">
                                                    <div class="col col-3  pt-2 mx-0 mt-3">Tanggal Berangkat</div>
                    ...
                    <!-- MODAL SURAT -->
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-white" style="background-color: #a9d08e;">
                        ...
                        <div class="col-12 card tumpul table-borderless mt-2">
                            <table id="datatablesSimple" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    include "../../../../koneksi.php";
                                    $no = 1;
                                    $sql = "SELECT * FROM dispensasi WHERE nrp = '$_SESSION[nrp]' ORDER BY id DESC;";
...
$code = mysqli_query($conn, "SELECT max(id) AS maxID FROM dispensasi WHERE date_req >= CURRENT_DATE");
...
function sendMessage()
{
    ...
    $content = array(
        "en" => "Terdapat Permintaan Dispensasi Dari Bapak/Ibu $nama"
    );
...
$alert = "<script>    
        Swal.fire({
            title: 'Form Dispensasi Berhasil Dibuat',
            icon: 'success',
...
if (isset($_POST['submit'])) {
    ...
    $rencana = htmlspecialchars($_POST['rencana_kembali']);
    $jam_kembali = htmlspecialchars($_POST['jam_kembali']);
    $approval = "$_SESSION[role]" + 1;

    if ($_SESSION['role'] == 2) {
        $sql = mysqli_query($conn, "INSERT INTO dispensasi VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$keperluan','$tanggal_berangkat','$shift','$jam_berangkat','$jam_kembali','$rencana',5,(NOW()),'none' )");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert";
        ...
        echo "$alert";
         ...
         if($_SESSION['seksi'] == 'Budget - Asset' || $_SESSION['seksi'] == 'Cost - G/L') {
          $sql = mysqli_query($conn, "INSERT INTO dispensasi VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$keperluan','$tanggal_berangkat','$shift','$jam_berangkat','$jam_kembali','$rencana',2,'','none' )");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert";   
         }else{
          $sql = mysqli_query($conn, "INSERT INTO dispensasi VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$keperluan','$tanggal_berangkat','$shift','$jam_berangkat','$jam_kembali','$rencana','$approval','','none' )");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert";   
