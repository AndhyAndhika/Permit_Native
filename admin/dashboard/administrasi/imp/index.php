                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="POST">
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
                                <div class="modal-content ">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel ">Izin Meninggalkan Pekerjaan</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row ">
                                            ...
                                            <div class="col col-12  col-lg-6 pr-3">
                                                <div class="row">
                                                    <div class="col col-3  pt-3 mx-0">Keperluan</div>
                    ...
                    <div class="row mt-2">
                        <div class="col card-body tumpul bg-light-biru text-white" style="background-color: #ff8f8f;">
                            ...
                            <span>B e r i k u t &ensp; A d a l a h &ensp; R i w a y a t &ensp; I z i n &ensp; M e n i n g g a l k a n &ensp; P e k e r j a a n &ensp;</span>
                        </div>
                        <div class="col-12 card tumpul table-borderless mt-2">
                            <table id="datatablesSimple" class="table table-hover table-responsive border w-100 d-block d-md-table" style="color:black">
                                ...
                                <tbody class="table-light">
                                    ...
                                    include "../../../../koneksi.php";
                                    $no = 1;
                                    $sql = "SELECT * FROM imp WHERE nrp = '$_SESSION[nrp]' ORDER BY id DESC;";
...
$code = mysqli_query($conn, "SELECT max(id) AS maxID FROM imp WHERE date_req >= CURRENT_DATE");
...
function sendMessage()
{
    ...
    $content = array(
        "en" => "Terdapat Permintaan Izin Meninggalkan Pekerjaan Dari Bapak/Ibu $nama"
    );
...
$alert = "<script>    
        Swal.fire({
            title: 'Form IMP Berhasil Dibuat',
            icon: 'success',
...
if (isset($_POST['submit'])) {
    ...
    $tanggal = htmlspecialchars($_POST['tanggal_mulai']);
    ...
    if ($_SESSION['role'] == 2) {
        $sql = mysqli_query($conn, "INSERT INTO imp VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$tanggal','$shift','$jam_berangkat','$rencana','$jam_kembali','$keperluan',5,(NOW()),'none')");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert";
        ...
        echo "$alert";
         ...
         if($_SESSION['seksi'] == 'Budget - Asset' || $_SESSION['seksi'] == 'Cost - G/L') {
            $sql = mysqli_query($conn, "INSERT INTO imp VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$tanggal','$shift','$jam_berangkat','$rencana','$jam_kembali','$keperluan',2,NULL,'none')");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert"; 
         }else{
               $sql = mysqli_query($conn, "INSERT INTO imp VALUES ('$kodeauto',(NOW()),'$_SESSION[nrp]','$_SESSION[nama]','$_SESSION[role]','$_SESSION[jabatan]','$_SESSION[seksi]','$_SESSION[departemen]','$_SESSION[divisi]','$tanggal','$shift','$jam_berangkat','$rencana','$jam_kembali','$keperluan','$approval',NULL,'none')");
        $response = sendMessage(); // 1
        $return["allresponses"] = $response; // 2
        $return = json_encode($return); // 3 baris buat kirim notif
        echo "$alert";
